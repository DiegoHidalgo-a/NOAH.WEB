        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg transform hover:-translate-y-2 transition-all duration-300">
              ...
              />
              <h3 className="text-xl font-bold text-center mb-4">Champions League</h3>
              <p className="text-gray-600 text-center">2023/24</p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg transform hover:-translate-y-2 transition-all duration-300">
              <img 
                ...
                className="w-24 h-24 object-cover mx-auto mb-4 rounded-full"
              />
              <h3 className="text-xl font-bold text-center mb-4">Premier League</h3>
              <p className="text-gray-600 text-center">2023/24</p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg transform hover:-translate-y-2 transition-all duration-300">
              <img 
                ...
                className="w-24 h-24 object-cover mx-auto mb-4 rounded-full"
              />
              <h3 className="text-xl font-bold text-center mb-4">FA Cup</h3>
              <p className="text-gray-600 text-center">2023/24</p>
            </div>
          </div>
        </div>
